...
struct qt_meta_stringdata_ProductionJob_t {
    QByteArrayData data[1];
    char stringdata0[14];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ProductionJob_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ProductionJob_t qt_meta_stringdata_ProductionJob = {
    {
QT_MOC_LITERAL(0, 0, 13) // "ProductionJob"
...
static const uint qt_meta_data_ProductionJob[] = {
...
QT_INIT_METAOBJECT const QMetaObject ProductionJob::staticMetaObject = { {
    &Job::staticMetaObject,
    qt_meta_stringdata_ProductionJob.data,
    qt_meta_data_ProductionJob,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_ProductionJob.stringdata0))
        return static_cast<void*>(this);
...
struct qt_meta_stringdata_ValidationJob_t {
    QByteArrayData data[1];
    char stringdata0[14];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ValidationJob_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ValidationJob_t qt_meta_stringdata_ValidationJob = {
    {
QT_MOC_LITERAL(0, 0, 13) // "ValidationJob"
...
static const uint qt_meta_data_ValidationJob[] = {
...
QT_INIT_METAOBJECT const QMetaObject ValidationJob::staticMetaObject = { {
    &Job::staticMetaObject,
    qt_meta_stringdata_ValidationJob.data,
    qt_meta_data_ValidationJob,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_ValidationJob.stringdata0))
        return static_cast<void*>(this);
    return Job::qt_metacast(_clname);
}
