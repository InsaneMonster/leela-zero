...
QT_MOC_LITERAL(1, 8, 8), // "sendQuit"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 9) // "readInput"

    },
    "Console\0sendQuit\0\0readInput"
};
...
void Console::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Console::sendQuit)) {
                *result = 0;
                return;
            }
        }
